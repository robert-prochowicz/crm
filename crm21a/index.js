// --- Data ---
const customerData = [
  { "timestamp": "2025-08-29 18:19:31", "account_id": 70711985, "first_name": "Kenneth", "last_name": "Gutierrez", "age": 60, "phone": "(280) 302-7847", "state": "WI" },
...
function createDashboardElement() {
  const state = {
    customers: [...customerData], // Use a copy of the data
  };
  ...
  const updateTable = () => { 
    state.customers.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
